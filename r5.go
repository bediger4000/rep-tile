...
50 50 scale
.01 setlinewidth`)
	drawReptile(2, 0., 0., 1.0, 1.0, 1.0)

	/*
		drawReptile(1, .0, .0, .50, 1.0, 1.0)    // A (0., 0.) 0.5 <1, 1>    x     y
		drawReptile(1, .5, .5, .50, -1.0, 1.0)   // B (.5, .5) 0.5 <-1, 1>   x+s   y+s
		drawReptile(1, -.5, .5, .50, 1.0, 1.0)   // C (-.5,.5) 0.5 <1, 1>    x-s   y+s
		drawReptile(1, -.5, -.5, .50, 1.0, -1.0) // D (-.5,-.5) 0.5 <1, -1>  x-s   y-s
	*/
...
func drawReptile(ply int, x, y float64, scale float64, xFlip, yFlip float64) {
	...
	if ply > 0 {
		s := scale / 2.0
		drawReptile(ply, x, y, s, xFlip, yFlip)      // A (0., 0.) 0.5 <1, 1>    x     y
		drawReptile(ply, x+s, y+s, s, -xFlip, yFlip) // B (.5, .5) 0.5 <-1, 1>   x+s   y+s
		drawReptile(ply, x-s, y+s, s, xFlip, yFlip)  // C (-.5,.5) 0.5 <1, 1>    x-s   y+s
		drawReptile(ply, x-s, y-s, s, xFlip, -yFlip) // D (-.5,-.5) 0.5 <1, -1>  x-s   y+s
	}
